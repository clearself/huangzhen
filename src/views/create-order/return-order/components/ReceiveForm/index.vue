<template>
  <div class="modal-wrapper" :class="{ 'modal-footer': status }" ref="mymodal">
    <a-modal
      ...
      :title="$t('return-order.columns.receiveInfo')"
      width="500px"
    ...
    >
      <a-form :model="formData" labelWrap :labelCol="{ style: { width: '120px' } }">
        <a-form-item :label="$t('return-order.receiver.name')" v-bind="validateInfos.name">
          <a-input
            :disabled="status"
            :maxlength="50"
            allowClear
        ...
        <a-form-item :label="$t('return-order.receiver.tel')" v-bind="validateInfos.tel">
          <a-input
            :disabled="status"
            :maxlength="50"
            allowClear
        ...
        <a-form-item :label="$t('return-order.receiver.country')">
          <a-input
            :disabled="status"
            :maxlength="100"
            allowClear
        ...
        <a-form-item :label="$t('return-order.receiver.province')">
          <a-input
            :disabled="status"
            :maxlength="100"
            allowClear
        ...
        <a-form-item :label="$t('return-order.receiver.city')">
          <a-input
            :disabled="status"
            :maxlength="100"
            allowClear
        ...
        <a-form-item :label="$t('return-order.receiver.street')">
          <a-input
            :disabled="status"
            :maxlength="100"
            allowClear
        ...
        <a-form-item :label="$t('return-order.receiver.address')">
          <a-input
            :disabled="status"
            :maxlength="100"
            allowClear
        ...
        <a-form-item :label="$t('return-order.receiver.code')">
          <a-input
            :disabled="status"
            :maxlength="100"
            allowClear
