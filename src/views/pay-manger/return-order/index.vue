  ...
  <div class="search-wrapper">
    <a-card size="small">
      <a-form :model="formData" layout="inline">
        <a-form-item :label="$t('return-pay-order.columns.supplierName')">
          <a-select
            show-search
        ...
        <a-form-item :label="$t('return-pay-order.columns.customerName')">
          <a-select
            show-search
        ...
        <a-form-item :label="$t('return-pay-order.columns.approvalStatus')">
          <a-select
            show-search
        ...
        <a-form-item :label="$t('return-pay-order.columns.purchaseOrder')">
          <a-input
            style="width: 240px"
            allowClear
            :placeholder="$t('inputTips')"
            v-model:value="formData.purchaseOrder"
          />
        </a-form-item>
        <a-form-item :label="$t('return-pay-order.columns.payOrder')">
          <a-input style="width: 240px" allowClear :placeholder="$t('inputTips')" v-model:value="formData.payOrder" />
        </a-form-item>
        <a-form-item>
          <div>
