  ...
  <div class="w100">
    <a-form :model="formData" labelAlign="left" autocomplete="off" @finish="onFinish" @finishFailed="onFinishFailed">
      <div class="ub ub-ac w100 ub-pj">
        <div>{{ $t('return-pay-order.purchaseOrdernumber') }}:POHW230811100118</div>
        <div>
      ...
      <a-card class="w100">
        <a-descriptions
          ...
          bordered
          :title="$t('return-pay-order.tableTitle')"
          size="small"
          :column="{ xxl: 4, xl: 3, lg: 3, md: 3, sm: 2, xs: 1 }"
        >
          <a-descriptions-item :label="$t('return-pay-order.columns.mappingOrder')">{{
            formData.id
          }}</a-descriptions-item>
          <a-descriptions-item :label="$t('return-pay-order.columns.payTime')">
          ...
          <a-descriptions-item :label="$t('return-pay-order.columns.payType')">
          ...
          <a-descriptions-item :label="$t('return-pay-order.columns.payMethod')">
            <span>{{ formData.payMethod }}</span>
          </a-descriptions-item>
          <a-descriptions-item :label="$t('return-pay-order.columns.currency')">
            <span>{{ formData.currency }}</span>
          </a-descriptions-item>
          <a-descriptions-item :label="$t('return-pay-order.columns.payAmount')">
          ...
          <a-descriptions-item :label="$t('return-pay-order.columns.customerName')">字节</a-descriptions-item>
          <a-descriptions-item :label="$t('return-pay-order.columns.supplierName')">字节</a-descriptions-item>
          <a-descriptions-item :label="$t('return-pay-order.columns.remark')">
      ...
      <div class="w100">
        <a-tabs v-model:activeKey="activeKey" @change="change">
          <a-tab-pane key="1" :tab="$t('return-pay-order.tab1')">
            <Annex />
          </a-tab-pane>
        </a-tabs>
      </div>
