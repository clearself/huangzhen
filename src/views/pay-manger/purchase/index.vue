  ...
  <div class="search-wrapper">
    <a-card size="small">
      <a-form :model="formData" layout="inline">
        <a-form-item :label="$t('purchase-pay.columns.supplierName')">
          <a-select
            show-search
        ...
        <a-form-item :label="$t('purchase-pay.columns.customerName')">
          <a-select
            show-search
        ...
        <a-form-item :label="$t('purchase-pay.columns.approvalStatus')">
          <a-select
            show-search
        ...
        <a-form-item :label="$t('purchase-pay.columns.purchaseOrder')">
          <a-input
            style="width: 240px"
            allowClear
        ...
        <a-form-item :label="$t('purchase-pay.columns.payOrder')">
